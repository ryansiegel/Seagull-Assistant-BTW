...
async def on_message(message):
	...
	if bot.get_channel(int(message.channel.id)) == bot.pvpChallengesChannel:
		...
		embedVar.add_field(name="March Challenges",value="https://discord.com/channels/811301587997687868/948750848350126080/951317452439035945", inline=True)
		embedVar.add_field(name="April Challenges",value="Coming April 1st", inline=True)
